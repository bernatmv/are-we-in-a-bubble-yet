...
export const copy = {
  en: {
    ...
    aboutKicker: 'WHAT THE SCORE MEANS', aboutTitle: ['Are we in a stock market bubble?', 'The evidence says yes.'],
    aboutP1: 'A bubble is not simply a market at an all-time high. It is a market where prices, leverage and confidence detach from the economic fundamentals beneath them. Today, several independent measures are flashing together.',
    aboutP2: 'The Shiller CAPE and market-value-to-GDP ratio measure valuation. FINRA margin debt measures investor leverage. High-yield spreads and the VIX show whether credit markets and investors are still relaxed about risk.',
  ...
  es: {
    ...
    aboutKicker: 'QUÉ SIGNIFICA EL ÍNDICE', aboutTitle: ['¿Hay una burbuja en la bolsa?', 'La evidencia dice que sí.'],
    aboutP1: 'Una burbuja no es simplemente un mercado en máximos históricos. Aparece cuando los precios, el apalancamiento y la confianza se separan de los fundamentos económicos. Hoy coinciden varias señales independientes.',
    aboutP2: 'El CAPE de Shiller y el valor de mercado frente al PIB miden la valoración. La deuda de margen de FINRA mide el apalancamiento. Los diferenciales de alto rendimiento y el VIX muestran cuánto riesgo perciben el crédito y los inversores.',
...
export const indicatorCopy = {
  es: {
    ...
    credit: { name: 'Diferencial high yield', eyebrow: 'CRÉDITO · 12% DEL ÍNDICE', description: 'Rentabilidad adicional exigida a empresas de menor calidad crediticia. Un diferencial muy estrecho indica que los prestamistas perciben poco riesgo.', threshold: 'Complacencia por debajo del 3,25%', change: 'Los prestamistas perciben poco riesgo' },
